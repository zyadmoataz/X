...
const ImageEditor = ({
  ...
  // hover on set settings and take it copy paste
  ...
  const handleChangeSensitive = (sensitive: boolean) => {
    // take the previous value and update it as we only will change the sensitive
  ...
  return (
    // this is a modal that will be displayed when we click on the image
    <div className="fixed w-screen h-screen left-0 top-0 bg-black bg-opacity-75 z-10 flex items-center justify-center">
      ...
      <div className="bg-black rounded-xl p-12 flex flex-col gap-4">
        ...
        {/* use next js image as we will not be uploading the image */}
          <Image
            src={previewURL}
            alt=""
            width={600}
        ...
        <div className="flex items-center justify-between text-sm">
          ...
          <div
            ...
            // we made it a callback function because we want to toggle the state when we click on it as it will change the state
