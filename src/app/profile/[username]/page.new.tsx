  ...
  useEffect(() => {
    const fetchProfileData = async () => {
      ...
      try {
        ...
        // Set followers and following counts from user data if available
    ...
    <div className="min-h-screen">
      ...
      <div className="relative px-4 pb-4 border-b border-borderGray">
        ...
        <div className="flex gap-4 text-sm">
          ...
          {profile.created_at && (
            <div className="flex items-center gap-1">
              <span className="text-textGray">Joined {new Date(profile.created_at).toLocaleDateString('en-US', {
                month: 'long',
                year: 'numeric'
              })}</span>
            </div>
      ...
      <div className="divide-y divide-borderGray">
        ...
        {activeTab === 'replies' && (
          <div className="py-10 text-center">
            ...
            <h2 className="text-lg font-bold mb-1">No replies yet</h2>
            <p className="text-gray-500 text-sm">
              When this user replies to posts, they will show up here.
            </p>
          </div>
        )}
        ...
        {activeTab === 'media' && (
          <div className="py-10 text-center">
            ...
            <h2 className="text-lg font-bold mb-1">No media yet</h2>
            <p className="text-gray-500 text-sm">
        ...
        {activeTab === 'likes' && (
          <div className="py-10 text-center">
            ...
            <h2 className="text-lg font-bold mb-1">No likes yet</h2>
            <p className="text-gray-500 text-sm">
              Posts this user has liked will show up here.
            </p>
          </div>
        )}
      </div>
