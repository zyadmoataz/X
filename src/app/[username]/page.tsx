...
const UserPage = () => {
  return (
    <div className="">
      {/* PROFILE TITLE */}
      {/* #00000084 is is black color but we changed the opacity */}
      ...
      <div className="">
        ...
        <div className="relative w-full">
          {/* COVER */}
          {/* width is 3 times bigger the height | -translate-y-1/2 in the second image is to center it in the main conatainer  */}
